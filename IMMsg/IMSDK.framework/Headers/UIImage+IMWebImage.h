 ...
 */
+ (nullable UIImage *)im_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (nullable UIImage *)im_imageWithColor:(UIColor *)color;
 ...
 */
+ (nullable UIImage *)im_imageWithColor:(UIColor *)color size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)im_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock;
 ...
 */
- (void)im_drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips;
 ...
 */
- (nullable UIImage *)im_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return The new image with the given size.
 */
- (nullable UIImage *)im_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
 ...
 */
- (nullable UIImage *)im_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)im_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
...
/**
 ...
 @param radius  The radius of each corner oval. Values larger than half the
                ...
                the width or height.
 */
- (nullable UIImage *)im_imageByRoundCornerRadius:(CGFloat)radius;
 ...
 */
- (nullable UIImage *)im_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)im_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)im_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)im_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)im_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)im_imageByFlipHorizontal;
 ...
 */
- (nullable UIImage *)im_imageByBlurWithTint:(UIColor *)tintColor;
...
/**
 ...
 @return               image with effect, or nil if an error occurs (e.g. no
                       enough memory).
 */
- (nullable UIImage *)im_imageByBlurRadius:(CGFloat)blurRadius
